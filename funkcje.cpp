...
extern std::vector<gracz> tabela;
...
int menu1() {
    ...
    szablon = pomocnicza1;
    bool czypelne = !tabela.empty();
    system("cls");

    std::cout << zamiana("1.Nowa gra", 1);

    if (czypelne == true) { std::cout << zamiana("2.Tabela wyników", 2); }
...
gracz level(int poziom) {
   ...
   szablon = pomocnicza1;
   system("cls");
      std::cout << zamiana("Wybierz tryb gry:", 0);
      std::cout << zamiana("1.Normalny", 2);
      std::cout << zamiana("2.Tryb zak³adu", 3);
      std::cout << zamiana("Nacisnij ESC zeby wrocic do menu", 6);
         char x = ' ';
         while (x != '1' && x != '2' && x != 27) {
               x = _getch();
         }
         ...
         szablon = pomocnicza1;
             ...
             while (lp > 0) {
                 ...
                 std::string pomocnicza3 = szablon; // Szablon z czysta 3 linia
                 std::cout << zamiana(wprowadzanie_liczby, 3);
                 ...
                 int xy = 1;
                 while (xy != 0) {                   //wprowadzanie liczby 
                     system("cls");
